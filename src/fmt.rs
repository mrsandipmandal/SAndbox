...
fn tok_str(tok: &Token) -> String {
    match tok {
        ...
        Token::TypeI8 => "i8".into(),
        Token::TypeI16 => "i16".into(),
        Token::TypeI32 => "i32".into(),
        Token::TypeU8 => "u8".into(),
        Token::TypeU16 => "u16".into(),
        Token::TypeU32 => "u32".into(),
        Token::TypeU64 => "u64".into(),
        Token::TypeUsize => "usize".into(),
        Token::As => "as".into(),
